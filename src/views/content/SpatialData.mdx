...
import RasterSourceOL from "../../maps/RasterSourceOL.jsx"
...
{/* Add interaction comparing vector data (polygon) and raster data*/}
{/* + Example showing the where and what of spatial data (e.g., map with points and a data table) */}
{/* https://turfjs.org/docs/#tin */}
...
{/* You can play with bands in a satellite image to get NDVI https://openlayers.org/en/latest/examples/cog-stretch.html */}
{/* https://openlayers.org/en/latest/examples/index.html?q=cog */}
...
{/* Add interaction comparing RTIN by MapBox (MARTINI or DELATIN) or @turf/tin and DEM GeoTIFF */}
