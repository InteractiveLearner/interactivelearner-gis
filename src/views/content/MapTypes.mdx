import ContentFigure from "../../components/Figure.jsx";
...
<ContentFigure img={datatypeImg} title={"Channel Ranking"} credit={"Credit: PennState licensed under CC BY-ND 2.0"} url={"https://creativecommons.org/licenses/by-nc-sa/4.0/"} />
...
<CardMedia height={1000} src="https://arcg.is/19vjX50" component="iframe"/>
