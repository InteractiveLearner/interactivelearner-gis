...
<DashCarousel style={{width: "100%"}}>
  <DashCarouselItem visible>
    <CalciteShell className="calcite-mode-dark">
      ...
      <ArcgisMap itemId="df123277063044cbb5ddbcd61c2f6820" zoom="4">
  ...
  <DashCarouselItem>
    <CalciteShell className="calcite-mode-dark">
      ...
      <ArcgisMap itemId="b247e64a3d6a45ffaa63bbba12726db3" zoom="2">
        <ArcgisLegend position="bottom-left"/>
      </ArcgisMap>
    </CalciteShell>
  </DashCarouselItem>
  ...
  <DashCarouselItem>
    <CalciteShell className="calcite-mode-dark">
      ...
      <ArcgisMap itemId="11e173a4e2f040ae80d39e44ee29467a" zoom="7.5">
        <ArcgisExpand position="top-right">
          <ArcgisLayerList />
        </ArcgisExpand>
        <ArcgisLegend position="bottom-left" />
