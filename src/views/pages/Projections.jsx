      ...
      <Container maxWidth="md" style={{ padding: "20px 0" }}>
        ...
        <div style={{ padding: "0px 16px 16px 16px" }}>
          ...
          <p>
            ...
            <b>large-scale</b> bottom right button in the map, you will see
            downtown Victoria with a high level of detail. As a result, you lose
            sight of municipality names but gain sight of street names and
            buildings.
          </p>
          ...
          <ul>
            <li>
              When you select the small-scale button, the graphic scale's length
              (or map distance) is approximately 1 centimeter and it's ground
              distance is 2.5 kilometers.
              <ul>
                <li>Verbally: One centimeter corresponds to 2.5 kilometers</li>
                <li>
                  As a representative fraction: Convert 2.5 km to 250,000 cm and
                  divide 1 cm by 250,000 cm which gives you 1:250,000 or
                  1/250,000
                </li>
              </ul>
            </li>
            <li>
              ...
              distance is approximately 1 centimeter and it's ground distance is
              300 meters.
              <ul>
                <li>Verbally: One centimeter corresponds to 300 meters</li>
                <li>
                  As a representative fraction: Convert 300 m to 30,000 cm and
                  divide 1 cm by 30,000 cm which gives you 1:30,000 or 1/30,000
                </li>
                <ul>
                  <li>
