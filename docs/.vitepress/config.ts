...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Easily learn about GIS in an interactive environment.' }],
    ['meta', { property: 'og:type', content: 'website' }],
    ['meta', { property: 'og:image', content: 'https://www.interactivelearner-gis.com/logo512.png' }],
    ['meta', { property: 'og:url', content: 'https://www.interactivelearner-gis.com/' }],
    ...
    ['meta', { name: 'msvalidate.01', content: 'F28D7B10FB5236446647B899521D9F78' }],
    // Google Search Console verification
    ['meta', { name: 'google-site-verification', content: 'rGtCWgNz493g9zMLokbID0wxeP58x9hL8M_7jX8A2dI' }]
  ],
  themeConfig: {
    logo: { src: '/logo192.png', width: 26, height: 26 },
    socialLinks: [
        { icon: 'github', link: 'https://github.com/InteractiveLearner/interactivelearner-gis/' }
      ],
    nav: [
      {
        text: 'Lessons',
